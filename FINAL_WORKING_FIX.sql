-- =====================================================
-- FINAL WORKING FIX FOR SOUTHERN LEE WRESTLING
-- =====================================================
-- This works with the ACTUAL database structure

-- IMPORTANT: Only run each section once!

-- Step 1: Check current weight classes
...
-- Step 2: Insert basic weight classes if none exist (using correct column names)
...
-- Step 3: Update any existing weight classes to use consistent division naming
...
-- Step 6: Check constraints (should show the existing constraint)
SELECT conname, contype 
FROM pg_constraint 
WHERE conname LIKE '%division%' 
  AND conrelid = 'weightclasses'::regclass; 